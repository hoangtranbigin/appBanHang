...
export default class ProductDetail extends Component {
    ...
    render() {
        ...
        const color = navigation.getParam('color', 'some default value');
        const material = navigation.getParam('material', 'some default value');
        const description = navigation.getParam('description', 'some default value');
        const images = navigation.getParam('images', 'some default value');
        const {
